...
private:
    ...
    Array<float> frequencies = {30.0f, 40.0f, 50.0f, 60.0f, 70.0f, 100.0f, 200.0f, 300.0f, 400.0f, 500.0f, 600.0f, 700.0f, 1000.0f, 2000.0f, 3000.0f, 4000.0f, 5000.0f, 6000.0f, 7000.0f, 10000.0f};
